<%-- 
    Document   : home
    Created on : Mar 10, 2025, 2:29:14 AM
    Author     : Admin
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>QUANG MINH - ONLINE BOOK STORE</title>
    ...
    <body class="shop">
        ...
        <header>
            ...
            <jsp:include page="common/header/header-top-area.jsp"></jsp:include>
            <!-- header-top-area-end -->

            <!-- header-mid-area-start -->
            <jsp:include page="common/header/header-mid-area.jsp"></jsp:include>
            <!-- header-mid-area-end -->
            
            <!-- main-menu-area-start -->
            <jsp:include page="common/header/main-menu-area.jsp"></jsp:include>
            <!-- main-menu-area-end -->
            
            <!-- mobile-menu-area-start -->
            <jsp:include page="common/header/mobile-menu-area.jsp"></jsp:include>
